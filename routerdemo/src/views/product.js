      ...
      <div>
        ...
        <ul>
          {books.map((book) => <li key={book.id}>
            ...
            <button onClick={books.removeBook(book.id)} >Remove</button></li>)}
        </ul>
        <div>
          ...
          contentLabel="Add Book">
              ...
              <div> Please fill all the inputs to make a new book</div>
                  ...
                  <button onClick={books.newBook(document.getElementById("title"),document.getElementById("bookInfo"),document.getElementById("moreInfo"))}>Add new Book</button>
